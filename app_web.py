...
def main():
    ...
    with tab1:
        ...
        if uploaded_dwg:
            ...
            safe_name = re.sub(r'[^a-zA-Z0-9_\- ]', '', client_name).strip() or "Projek"
            ...
            excel_filename = f"{safe_name}_Template_{kwp_val}kWp.xlsx"
    ...
    with tab2:
        ...
        if uploaded_checked_excel:
            ...
            safe_name_ex = re.sub(r'[^a-zA-Z0-9_\- ]', '', client_name_ex).strip() or "Projek"
            ...
            pdf_out_name = f"{safe_name_ex}_PVsyst_Report_{kwp_ex}kWp_{'1Battery' if has_bat else 'NoBattery'}.pdf"
